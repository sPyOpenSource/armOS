...
$(HEADER_BUILD)/qstrdefs.generated.h: $(PY_QSTR_DEFS) $(QSTR_DEFS) $(QSTR_DEFS_COLLECTED) $(PY_SRC)/python/makeqstrdata.py mpconfigport.h $(MPCONFIGPORT_MK) $(PY_SRC)/headers/mpconfig.h | $(HEADER_BUILD)
	$(ECHO) "GEN $@"
